...
<head>
    ...
    <style>
        ...
        .login-card {
            ...
            padding: 22px 18px 18px 18px; /* lebih pendek */
        ...
        .btn-next, .btn-prev { min-width: 120px; }
    </style>
</head>
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="card-title">Register Akun Pelanggan</div>
            <form method="POST" action="{{ route('registerpelanggan') }}" id="registerForm" enctype="multipart/form-data">
                @csrf
                <!-- STEP 1: Data Akun -->
                <div class="step-section step-1 active">
                    ...
                    <div class="form-row-flex">
                        <div class="form-group">
                            <label for="nama_pelanggan">Nama Lengkap <span class="text-warning">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Email aktif" required>
                            @error('email')
                                <span class="invalid-feedback" role="alert" style="color:#fff;">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label for="katakunci">Password <span class="text-warning">*</span></label>
                            <div class="input-group">
                                <input type="password" class="form-control @error('katakunci') is-invalid @enderror" id="katakunci" name="katakunci" placeholder="Password" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" value="{{ old('no_telp') }}" placeholder="No. Telepon">
                            @error('no_telp')
                                <span class="invalid-feedback" role="alert" style="color:#fff;">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <button type="button" class="btn btn-back-home" onclick="window.location.href='/'">
                            <i class="fas fa-arrow-left me-1"></i> Kembali
                        </button>
                        <button type="button" class="btn btn-login btn-next">Selanjutnya</button>
                    </div>
                </div>
                <!-- STEP 2: Alamat Utama -->
                <div class="step-section step-2">
                    <div class="form-section-title">Alamat Utama</div>
                    <div class="form-row-flex">
                        <div class="form-group">
                            <label for="alamat1">Alamat</label>
                            <input type="text" class="form-control @error('alamat1') is-invalid @enderror" id="alamat1" name="alamat1" value="{{ old('alamat1') }}" placeholder="Alamat">
                            @error('alamat1')
                                <span class="invalid-feedback" role="alert" style="color:#fff;">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kota1') is-invalid @enderror" id="kota1" name="kota1" value="{{ old('kota1') }}" placeholder="Kota">
                            @error('kota1')
                                <span class="invalid-feedback" role="alert" style="color:#fff;">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('propinsi1') is-invalid @enderror" id="propinsi1" name="propinsi1" value="{{ old('propinsi1') }}" placeholder="Provinsi">
                            @error('propinsi1')
                                <span class="invalid-feedback" role="alert" style="color:#fff;">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kodepos1') is-invalid @enderror" id="kodepos1" name="kodepos1" value="{{ old('kodepos1') }}" placeholder="Kode Pos">
                            @error('kodepos1')
                                <span class="invalid-feedback" role="alert" style="color:#fff;">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <button type="button" class="btn btn-secondary btn-prev"><i class="fas fa-arrow-left me-1"></i>Kembali</button>
                        <button type="submit" class="btn btn-login">Register</button>
                    </div>
                </div>
                <div class="text-center mt-3">
                    <a href="{{ route('loginpelanggan') }}" class="text-white">Sudah punya akun? Login di sini</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            btnNext.onclick = function() {
                ...
                let valid = true;
                step1.querySelectorAll('input[required]').forEach(function(input) {
                    if (!input.value.trim()) {
